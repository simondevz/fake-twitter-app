...
function PollsLogo({ className }) {
    return (
        <svg
            ...
            x="0px" 
            y="0px"
        	viewBox="0 0 65.667 65.667"
        	style={{enableBackground: "new 0 0 65.667 65.667"}} 
        >
            <path 
                d="M5.198,59.545H21.29c0.552,0,1-0.448,1-1V20.94c0-0.552-0.448-1-1-1H5.198c-0.552,0-1,0.448-1,1v37.605
